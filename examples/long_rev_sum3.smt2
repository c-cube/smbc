...
(define-funs-rec
   ...
   ((match l_4
      ...
      (case nil nil))))
(define-funs-rec ((two () nat)) ((s (s z))))
(define-funs-rec ((five () nat)) ((s (s (s (s (s z)))))))
(define-funs-rec ((ten () nat)) ((mult two five)))
(define-funs-rec ((twenty () nat)) ((mult two ten)))
(assert-not
 (forall
    ((l_5 list))
    (not (and
          (and (= (length l_5) ten) (= (sum l_5) twenty)) 
